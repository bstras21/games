      ...
      {allMatched ? (
        ...
        <main className="max-w-7xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            {/* Definitions Column */}
            <div className="bg-black/60 backdrop-blur-md rounded-3xl p-4 md:p-6 border border-neon-purple shadow-[0_0_20px_rgba(0,0,0,0.5)]">
                    ...
                    <button
                      ...
                      className={`w-full py-2.5 px-4 rounded-lg border text-left transition-all duration-200 relative ${
                        matched
                          ...
                          : selected
                          ? 'bg-black/80 border border-neon-purple text-white shadow-[0_0_15px_rgba(191,0,255,0.6)]'
                          : 'bg-black/65 border border-neon-purple/50 text-gray-200 hover:bg-black/75 hover:border-neon-purple active:bg-black/85'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`w-full py-3 px-4 rounded-lg border text-left transition-all duration-500 ${
                        isCorrect
                          ...
                          : 'bg-black/65 border-neon-purple/50 text-gray-200 hover:bg-black/75 hover:border-neon-purple active:bg-black/85'
                      }`}
                    >
                      <div className="flex items-start justify-between gap-2">
